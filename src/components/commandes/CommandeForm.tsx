...
const ligneSchema = z.object({
  ...
  quantite: z.number({ required_error: "Veuillez saisir une quantité" }).int().min(1, "La quantité doit être au moins de 1"),
  prix_unitaire: z.number({ required_error: "Prix requis" }).min(0, "Le prix doit être positif"),
  remise_pct: z.number().min(0).max(100).optional().default(0),
