      ...
      <SidebarProvider>
        ...
        <div className="flex min-h-dvh w-full">
          ...
          <div className="flex min-w-0 flex-1 flex-col">
            <header className="app-shell-header sticky top-0 z-30 flex h-16 items-center gap-2 border-b bg-card px-3 pt-[env(safe-area-inset-top)] sm:px-4">
              <SidebarTrigger />
              <Topbar />
            </header>
            ...
            <main
              className="app-shell-main min-w-0 flex-1 overflow-x-hidden overflow-y-auto p-3 pb-[calc(6rem+var(--keyboard-height,0px))] sm:p-4 md:pb-[calc(1rem+var(--keyboard-height,0px))] lg:p-6"
