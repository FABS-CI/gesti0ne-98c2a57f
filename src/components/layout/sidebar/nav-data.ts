...
export const groups: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Rôles & Permissions", url: "/roles-permissions", icon: ShieldCheck, ready: true, badge: "v1" },
      { title: "Rôles & Permissions (v2)", url: "/admin/roles-v2", icon: ShieldCheck, ready: true, badge: "nouveau" },
