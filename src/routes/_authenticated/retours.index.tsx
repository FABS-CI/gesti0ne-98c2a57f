      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          ...
          <Can permission="retours.creer">
            <Button onClick={() => navigate({ to: "/retours/nouveau", search: { clientId: undefined, type_retour: undefined } })}>
        ...
        {isLoading ? (
          ...
          <EmptyState
            ...
            action={
              !hasActiveFilters ? (
                <Can permission="retours.creer">
                  <Button size="sm" onClick={() => navigate({ to: "/retours/nouveau", search: { clientId: undefined, type_retour: undefined } })}>
