...
-- 2. Update functions to use type_notification and ensure metadata compatibility

-- 2.1 approbation_decider
...
BEGIN
  ...
  -- Insert notification with metadata and correct column name
