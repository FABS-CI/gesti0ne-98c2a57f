...
BEGIN
  ...
  -- CORRECTION : type -> type_notification
...
-- 2. Correct approbation_deleguer (IF IT EXISTS OR IF IT'S BROKEN)
...
BEGIN
  ...
  -- CORRECTION : type -> type_notification
  BEGIN
    INSERT INTO public.notifications (user_id, titre, message, type_notification, module, lien)
    VALUES (
      p_delegataire_id,
