-- =========================================================================
-- RPC 1 : convertir une proforma acceptée en commande (atomique)
-- =========================================================================
...
BEGIN
  ...
  IF NOT FOUND THEN
    RAISE EXCEPTION 'Proforma introuvable';
  END IF;
  IF v_pro.statut = 'acceptee' THEN
    RAISE EXCEPTION 'Proforma déjà convertie';
  END IF;
...
-- =========================================================================
-- RPC 2 : convertir une commande en BL (avec colisage + stock) - atomique
-- =========================================================================
...
BEGIN
  ...
  -- Références générées côté base pour éviter les collisions (nextval + timestamp)
