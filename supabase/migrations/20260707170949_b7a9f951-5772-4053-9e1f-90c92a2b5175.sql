...
BEGIN
  ...
  -- Après suppression du colisage, le BL redevient « À préparer »
  -- afin qu'il réapparaisse dans la liste des colisages à effectuer.
...
-- Réactiver les BL déjà supprimés pour qu'ils réapparaissent
UPDATE public.bons_livraison
SET statut = 'a_preparer', updated_at = now()
WHERE statut = 'colisage_supprime';