-- Fonction de classement pédagogique
...
-- Colonne générée pour tri serveur (compatible pagination Supabase)
ALTER TABLE public.produits
  ADD COLUMN IF NOT EXISTS niveau_ordre INT
  GENERATED ALWAYS AS (public.produit_niveau_ordre(niveau)) STORED;
