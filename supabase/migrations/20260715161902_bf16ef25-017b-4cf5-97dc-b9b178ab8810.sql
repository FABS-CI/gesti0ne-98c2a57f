-- Enum des rôles
CREATE TYPE public.app_role AS ENUM ('super_admin', 'admin', 'directeur', 'directeur_commercial', 'comptable', 'assistant_comptable', 'gestionnaire_stock', 'magasinier', 'secretaire', 'responsable_logistique', 'commercial', 'user');
