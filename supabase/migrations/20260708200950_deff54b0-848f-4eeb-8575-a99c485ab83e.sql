...
BEGIN
  ...
  INSERT INTO public.audit_events (user_id, action, module, table_name, record_id, record_ref, metadata)
  VALUES (auth.uid(), 'suppression_definitive', 'paiements', 'paiements', _paiement_id, v_ref,
