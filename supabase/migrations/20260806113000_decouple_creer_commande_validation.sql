-- Découplage de la validation automatique dans creer_commande
-- Ajout du paramètre _auto_validate dans le payload pour respecter le choix de l'utilisateur
...
BEGIN
  ...
  -- On vérifie les droits de validation
  ...
  -- Validation UNIQUEMENT si l'utilisateur l'a demandé ET a la permission
