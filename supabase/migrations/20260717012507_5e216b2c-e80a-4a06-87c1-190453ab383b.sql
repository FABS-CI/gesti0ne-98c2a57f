...
BEGIN
  ...
  INSERT INTO public.achats(fournisseur_id, libelle, montant, statut, date_achat,
    reference_fournisseur, notes, depot_id, created_by, created_by_nom)
  VALUES ((_payload->>'fournisseur_id')::uuid, 'Approvisionnement', v_total, 'recu',
    COALESCE((_payload->>'date_achat')::date, current_date),
    _payload->>'reference_fournisseur', _payload->>'notes', v_depot, auth.uid(),
